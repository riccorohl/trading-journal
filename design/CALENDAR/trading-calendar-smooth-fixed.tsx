...
export default function TradingCalendarSmoothFixed() {
  ...
  const animatingCalendarDays = animatingDate ? generateCalendarData(animatingDate.getFullYear(), animatingDate.getMonth()) : []
