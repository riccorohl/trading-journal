...
const TradeDetailsPage: React.FC<TradeDetailsPageProps> = ({ isEmbedded = false }) => {
  ...
  useEffect(() => {
    if (currentTrade) {
      ...
      // Trade not found, redirect back to trades list
      navigate('/');
    }
  ...
  return (
    <div className={isEmbedded ? "bg-gray-100" : "min-h-screen bg-gray-50"}>
      {/* Header with Navigation */}
      <div className={`bg-white border-b border-gray-200 ${isEmbedded ? 'px-6 py-4' : 'px-6 py-4'}`}>
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-4">
            ...
            <div className="flex items-center gap-3">
              <h1 className="text-3xl font-bold text-gray-900">{editedTrade.symbol}</h1>
      ...
      {/* Main Content */}
      <div className={isEmbedded ? "px-6 py-6" : "px-6 py-6"}>
        <Tabs value={activeTab} onValueChange={setActiveTab} className="w-full">
          ...
          <TabsContent value="overview" className="space-y-6">
            <div className="flex flex-col xl:flex-row gap-6">
              {/* Chart Section - Now takes more space on full page */}
              <div className="flex-1 xl:flex-[2]">
                <Card>
                  ...
                  <CardContent>
                    <div className="border-2 border-dashed border-gray-300 rounded-lg p-12 text-center min-h-[500px] flex flex-col items-center justify-center">
                      ...
                      <p className="text-gray-600 mb-4 max-w-md">
                        {chartType === 'HTF' 
                          ? 'Higher Time Frame chart for overall trend analysis and market structure'
                          : 'Lower Time Frame chart for precise entry/exit timing and execution details'
                        }
                      </p>
                      {isEditing && (
              ...
              {/* Metrics Section - Better proportions for full page */}
            ...
            <Card>
              ...
              <CardContent>
                ...
                {isEditing ? (
                  ...
                  <div className="min-h-40 p-4 border rounded-md bg-gray-50 mt-2">
